...
urlpatterns = [
    ...
    path("products/low_stock/count/", LowStockProductCountAPIView.as_view()),
    path("products/negative_stock/", NegativeStockProductAPIView.as_view(), name="negative_stock"),
    ...
    path("batch/<str:batch_id>/summary/", BatchSummary.as_view(), name="batch-summary"),
    path("batch/date_wise_summary/", BatchSummaryByDate.as_view(), name="date_wise_summary"),
    path("batch/<str:batch_id>/get_summary/", GetBatchSummary.as_view(), name="get-batch-summary"),
    path("batch/<str:batch_id>/confirm/", ConfirmBatch.as_view(), name="confirm-batch"),
    path("batch/<str:batch_id>/cancel/", CancelBatch.as_view(), name="cancel-batch"),
    path("batch/delete/<int:product_id>/", ProductDelete.as_view(), name="cancel-batch"),


    path('all_batch_id', UniqueBatchListAPIView.as_view(), name='all_batch_id'),

    path('batches/search/', BatchSearchAPIView.as_view(), name='batch-search'),
