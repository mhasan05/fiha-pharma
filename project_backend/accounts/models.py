...
class Area(models.Model):
    ...
    district = models.ForeignKey(District, on_delete=models.CASCADE, related_name="areas",default=1)
...
class UserAuth(AbstractBaseUser,PermissionsMixin):
    ...
    # Exact shop location (captured by the shop owner via GPS) so the delivery
    # man can navigate to the real pin. Null until the owner sets it.
