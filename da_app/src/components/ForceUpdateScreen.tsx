 ...
 * `force_update` on and the installed build is older. No back / close — the only
 * action is to download the new APK. Rendered in place of the app Stack.
 */
      ...
      >
        <View className="items-center">
          ...
          <Text className="mt-2 text-center text-[14px] leading-6 text-ink-muted">
            A new version of Fiha Pharma Rider is available. Please update to the latest version to keep using the app.
          </Text>

          {/* Version + size chips */}
          <View className="mt-4 flex-row" style={{ gap: 8 }}>
            <View className="flex-row items-center rounded-full bg-primary-50 px-3 py-1.5">
              <Ionicons name="rocket-outline" size={13} color={theme.color.primary} />
              <Text className="ml-1.5 text-[12px] font-bold text-ink">v{rel.updated_version}</Text>
            </View>
            {sizeMb ? (
              <View className="flex-row items-center rounded-full bg-primary-50 px-3 py-1.5">
                <Ionicons name="cloud-outline" size={13} color={theme.color.inkMuted} />
